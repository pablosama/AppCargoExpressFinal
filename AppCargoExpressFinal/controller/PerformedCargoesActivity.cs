...
namespace AppCargoExpressFinal.controller
{
    ...
    public class PerformedCargoesActivity : Activity
    {
        ...
        {
            new PerformedCargoes ("Eliecer Lopez","05/11/2016","Pto. Montt - Santiago","Mudanza","$550.000"),
            new PerformedCargoes ("Cristian Carvajal","06/11/2016","Santiago - Arica","Artículo Hogar","$100.000"),
            new PerformedCargoes ("Daniel Fuentes","07/11/2016","Coquimbo - Concepción","Industial","$170.000"),
            new PerformedCargoes ("Julio Toledo","08/11/2016","Concepción - Temuco","Carga Peligrosa","$210.000"),
            new PerformedCargoes ("Eduardo Oses","15/11/2016","Temuco - Osorno","Vehículos Menores","$80.000"),
            new PerformedCargoes ("Gabriel Parada","16/11/2016","Osorno - Lanco","Vehículos Mayores","$70.000"),
            new PerformedCargoes ("Fabián Mondaca","17/11/2016","Lanco - Valdivia","Carga Peligrosa","$100.000"),
            new PerformedCargoes ("Felipe Chavez","18/11/2016","Valdivia - Pto. Montt","Carga Peligrosa","$230.000"),
            new PerformedCargoes ("Rubén Guiñez","19/11/2016","Pto. Montt - Chiloé","Artículo Hogar","$50.000"),
            new PerformedCargoes ("Cristian Ulloa","20/11/2016","Pta. Arenas - Cohyaique","Mudanza","$200.000")
        };
